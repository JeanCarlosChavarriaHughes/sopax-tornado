...
import websockets
from pruebaAccionadorWafer import ejecutarComandos
...
class servidorSOPAX(object):
    ...
    def ejecutarDatafonoCashless(self, producto, monto):
        ...
        if ejecucionVenta == False:
            ...
            ventaExitosa = ejecutarComandos.vendRequest(ejecucionVenta,variablesProducto[0])
...
def show_entry_fields():
    ...
    ## DEBAJO ES PARA OBTENER LA IP DE FORMA AUTOMATICA
    #ingresoIPv4 = os.popen('ip addr show wlo1').read().split("inet ")[1].split("/")[0]

    ingresoIPv4 = "localhost"
    print(ingresoIPv4)
    #master.destroy()
